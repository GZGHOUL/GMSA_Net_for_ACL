...
import tqdm
from Dataset.data_loader import process_gait_dataframe
...
def main():
    ...
    x_train, y_train, person_ids_train = process_gait_dataframe(train_df, period_norm=False, label_type=config['label_type'])
    x_test, y_test, person_ids_test = process_gait_dataframe(test_df, period_norm=False, label_type=config['label_type'])
